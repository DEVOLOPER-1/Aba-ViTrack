    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                #=======test====
                # bbox=template_anno['bbox'][0]
                # template_masks=self._bbox_to_mask(box_xywh_to_xyxy(bbox), H, W)
                #
                # bbox=search_anno['bbox'][0]
                # search_masks=self._bbox_to_mask(box_xywh_to_xyxy(bbox), H, W)
                #===================
