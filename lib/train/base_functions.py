...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, MTCAIC4
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val",
                        "COCO17", "VID", "TRACKINGNET", "MTC_AIC4"]
        if name == "LASOT":
        ...
        if name == "MTC_AIC4":
            datasets.append(MTCAIC4(settings.env.mtc_aic4_dir, image_loader=image_loader))
    return datasets
