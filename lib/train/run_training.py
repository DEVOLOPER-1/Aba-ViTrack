...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 csl=None, script_teacher=None, config_teacher=None):
    ...
    if csl:
        ...
        expr_module = importlib.import_module('lib.train.train_script_csl')
    else:
...
def main():
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 csl=args.csl, script_teacher=args.script_teacher, config_teacher=args.config_teacher)
